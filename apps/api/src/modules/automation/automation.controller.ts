...
export class AutomationController {
  ...
  @Post("segments")
  createSegment(@Req() req: any, @Body() body: CreateSegmentDto) {
  ...
  @Get("triggers")
  listTriggers(@Req() req: any) {
    return this.automation.listTriggers(req.user.companyId);
  }

  @Post("triggers")
  createTrigger(@Req() req: any, @Body() body: CreateTriggerDto) {
    return this.automation.createTrigger(req.user.companyId, body);
  }

  @Patch("triggers/:id")
  updateTrigger(@Req() req: any, @Param("id") id: string, @Body() body: UpdateTriggerDto) {
  ...
  recordMetric(@Req() req: any, @Param("id") id: string, @Body() body: RecordMetricDto) {
