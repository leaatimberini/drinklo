  ...
  return (
    <main style={{ padding: 32, maxWidth: 760 }}>
      ...
      <section style={{ marginTop: 20, padding: 16, borderRadius: "var(--radius-md)", border: "1px solid var(--card-border)", background: "var(--card-bg)" }}>
        ...
        {providerType === "SMTP" ? (
          <p style={{ color: "var(--color-muted)" }}>
            Para SMTP, configura SPF con el host de tu proveedor y DKIM/DMARC seg�n las instrucciones del servicio.
          </p>
        ) : (
          <p style={{ color: "var(--color-muted)" }}>
      ...
      <section style={{ marginTop: 20 }}>
        ...
        <button onClick={confirm} style={{ marginLeft: 8 }}>Confirmar verificaci�n</button>
